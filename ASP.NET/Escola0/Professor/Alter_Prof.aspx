<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Alter_Prof.aspx.cs" Inherits="Alter_Prof" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
    ...
    <asp:Button ID="btnAlterar" runat="server" onclick="Button1_Click" 
        Text="Alterar" CssClass="btn" Width="56px" />
    <br />
    <br />
</asp:Content>
