...
import entity.CategoriaJpaController;
...
public class CategoriaController implements Serializable {
    ...
    private CategoriaJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new CategoriaJpaController(utx, emf);
        }
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getIdcategoria());
