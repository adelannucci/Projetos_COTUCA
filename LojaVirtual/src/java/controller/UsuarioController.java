...
import entity.UsuarioJpaController;
...
public class UsuarioController implements Serializable {
    ...
    public static class UsuarioControllerConverter implements Converter {
     ...
     public void login() {  
        int i = jpaController.logar(current.getNome(), current.getSenha());
        if(i == 1 || i == 2) {  
            JsfUtil.addSuccessMessage("Welcome");
        } else {   
            JsfUtil.addErrorMessage(new Exception(), "Login Error");   
        }  
        
        JsfUtil.setSession("Usuario", current.getNome());
        JsfUtil.setSession("Senha", current.getSenha());
        
        System.out.println(JsfUtil.getSession("Usuario"));
        System.out.println(JsfUtil.getSession("Usuario"));
    }
}
